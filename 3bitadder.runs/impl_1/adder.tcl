...
set rc [catch {
  ...
  set_property ip_repo_paths e:/PROJECT/3bitadder/3bitadder.cache/ip [current_project]
  set_property ip_output_repo e:/PROJECT/3bitadder/3bitadder.cache/ip [current_project]
  add_files -quiet E:/PROJECT/3bitadder/3bitadder.runs/synth_1/adder.dcp
